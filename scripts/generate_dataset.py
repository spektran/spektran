#!/usr/bin/env python
"""Generate an SPEKTRAN dataset from a dataset-config YAML.
...
from spektran.generator import GenerationSpec, generate_dataset  # noqa: E402
from spektran.instrument.sampling import load_instrument_config  # noqa: E402
from spektran.io import write_records  # noqa: E402
