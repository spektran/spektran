#!/usr/bin/env python
"""1D-Transformer baseline for T4 (WMS 2f concentration regression).

Patchified transformer encoder on the 2f demodulated signal: splits the
2000-point scan into 50-point patches, projects each patch to d_model,
adds learnable position embeddings, and runs a standard transformer
encoder before global-average pooling to a scalar. Trains on
...
beyond the val-split early stop. Reproduce:
    ...
    python baselines/transformer_t4/train.py
"""
